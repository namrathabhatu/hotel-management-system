    ...
    <body background="hotel12.jpg">
        ...
        <div class ="supreme">
          <div class ="animated slideInDown">
            <img src="lime wood.png" width="600" height= 399 border=0 alt="">
        </div>
        <div class = "animated fadeIn">
            <h1 name ="heading" class="hd" id="tre"> Lime Wood </h1>
            <a href = "slide1.py" style="float:left"><button><-- Back</button></a>
        </div>
        <form action ="slide4.py" method="get">
        <div class ="col-3">
